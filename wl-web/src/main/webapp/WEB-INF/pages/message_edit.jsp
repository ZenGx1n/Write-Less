    ...
    <section class="content container-fluid">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">修改留言信息</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form:form action="/backstageMessage/edit" modelAttribute="message" class="form-horizontal" role="form">
                <div class="box-body">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">编号</label>
                        <div class="col-sm-8">
                            <form:input path="number" cssClass="form-control" placeholder="" readonly="true"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div for="user" cssClass="form-control">
                                <form:input path="user.username" cssClass="form-control" placeholder="" readonly="true"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
