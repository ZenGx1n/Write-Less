...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>WriteLess后台</b>管理</span>
        </a>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="/user/list"><i class="fa fa-list-ol"></i> 全部用户<i style="float: right"
                                                                                          class="fa fa-angle-right"></i></a>
                        </li>
                        <li><a href="/user/to_add"><i class="fa fa-plus"></i> 添加用户<i style="float: right"
                                                                                         class="fa fa-angle-right"></i></a>
                        </li>
                    </ul>
                </li>
